...
- OpenCode: `/gsd-help`
- Codex: `$gsd-help`
- Copilot CLI: `/skills list` or use `/gsd-help` in a Copilot session

> [!NOTE]
> Codex and Copilot CLI installations use skills (`skills/gsd-*/SKILL.md`) rather than custom prompts. On Copilot CLI, invoke GSD workflows with `/gsd-<command>` (e.g. `/gsd-new-project`, `/gsd-help`).
...
# GitHub Copilot CLI (plugin/skills)
...
- For Copilot CLI, verify skills exist in `~/.copilot/skills/gsd-*/SKILL.md` (global) or `./.copilot/skills/gsd-*/SKILL.md` (local), and run `copilot plugin list` to confirm GSD is loaded
